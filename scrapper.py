...
def scrape_karkidi_jobs(keyword: str = "data science", pages: int = 1) -> pd.DataFrame:
    ...
    for page in range(1, pages + 1):
        ...
        try:
            ...
            print(f"⚠️ Failed to retrieve page {page}: {e}")
            continue
        ...
        if not job_blocks:
            print(f"⚠️ No job blocks found on page {page}")
...
def run_daily_job_check(keyword: str,
    ...
    """
    print(f"\n🔄 Checking new jobs for keyword: '{keyword}'")
    ...
    print(f"📁 Saved all jobs to: {all_jobs_path}")
